---
layout: default
title: Bienvenue dans la CdP de développement !
lang: fr
permalink: /fr/
---
...
Doter les développeurs d'EDSC des compétences et des connaissances nécessaires pour moderniser continuellement les logiciels qu'ils développent.  
Nous souhaitons que les développeurs d'EDSC collaborent entre eux et avec ceux d'autres ministères, en acquérant des compétences pour développer une plus grande diversité de connaissances, ce qui leur permettra de développer des logiciels plus robustes et polyvalents.
...
Utilisez ce formulaire pour soumettre une idée de sujet pour la DevCoP ou pour proposer une présentation lors d'une prochaine DevCoP. [lien](https://forms.office.com/r/kutUxZqfLx)
