...
<div class=".images" style="width: 60%;">
...
<div class=".images" style="width: 75%;">
...
<div class=".images" style="width: 80%;">
...
<div class=".images" style="width: 35%;">
    ![Create Repo in TFS - Step 5](/assets/tfvc-to-git/tfvc-to-git-create-repo-tfs2.jpg)
</div>
...
<img src="/assets/tfvc-to-git/tfvc-to-git-find-url-gccode2.jpg" class="images" style="width: 100%;" />
